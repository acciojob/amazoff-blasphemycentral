...
public class OrderService
{
    ...
    public Integer getOrdersLeftAfterGivenTimePartnerId(String deliveryTime, String partnerId)
    {
...
//        return orderRepository.getOrdersLeftAfterGivenTimeByPartnerId(newTime,partnerId);
        return orderRepository.getOrdersLeftAfterGivenTime(newTime, partnerId);
    }
